...
final public class IBAttributedButton: UIButton, TouchesExpandable {
    ...
    @IBInspectable public var horizontalTouchesOffset: CGPoint = .zero
    @IBInspectable public var verticalTouchesOffset: CGPoint = .zero

    public var touchesOffset: UIEdgeOffsets {
